...
export const NAV_TEMAS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/hub-lowcode/wsjf/planner-excel/instalar', icon: 'mdi-microsoft-excel', title: 'Instalar Planner → Excel WSJF', tip: 'Escolher ambiente de desenvolvimento, Planner, WSJF.xlsx e conexões sem copiar identificadores técnicos.' },
  ...
  },
  {
    ...
    subgroups: [
      ...
      },
      {
        ...
        topic: 'Auditoria, segredos, políticas e sessões',
        paths: ['/auditoria', '/segredos-status', '/governanca', '/admin/session-management', '/admin/teams-recipient-policies'],
      },
      {
        id: 'engenharia-ia',
        title: 'Engenharia e IA',
        topic: 'Especificações, revisão e orquestração técnica',
        paths: ['/specs', '/codex', '/admin/ocr-review', '/orquestrador-ia'],
      },
    ],
    items: [
      { to: '/monitoramento-operacional', icon: 'mdi-monitor-dashboard', title: 'Monitoramento', tip: 'Situação técnica das integrações, verificações obrigatórias, execução e pendências operacionais.', subgroupId: 'operacao' },
      { to: '/auditoria', icon: 'mdi-shield-search', title: 'Auditoria', tip: 'Linha do tempo de eventos e controles operacionais.', subgroupId: 'seguranca-governanca' },
      { to: '/segredos-status', icon: 'mdi-key-chain-variant', title: 'Segredos', tip: 'Diagnóstico da origem dos segredos do serviço.', subgroupId: 'seguranca-governanca' },
      { to: '/specs', icon: 'mdi-file-code-outline', title: 'Especificações', tip: 'Especificações técnicas e contratos das funcionalidades.', subgroupId: 'engenharia-ia' },
      { to: '/governanca', icon: 'mdi-shield-check-outline', title: 'Governança', tip: 'Verificações obrigatórias, automação de integração e publicação, monitoramento, políticas e evidências.', subgroupId: 'seguranca-governanca' },
      { to: '/codex', icon: 'mdi-code-braces', title: 'Codex', tip: 'Análise de código com modelo de IA local ou simulação, controlada pelo ReqSys.', subgroupId: 'engenharia-ia' },
      { to: '/admin/ocr-review', icon: 'mdi-text-box-search-outline', title: 'Revisão de leitura de documentos', tip: 'Revisar resultados de leitura automática abaixo do limite definido, com dados pessoais protegidos e decisão verificável.', subgroupId: 'engenharia-ia' },
      { to: '/admin/operational-deploy', icon: 'mdi-rocket-launch-outline', title: 'Central operacional', tip: 'Publicar serviço e aplicação no ambiente de desenvolvimento com confirmação, evidência e sem expor credenciais.', subgroupId: 'operacao' },
      { to: '/admin/session-management', icon: 'mdi-account-lock-outline', title: 'Sessões', tip: 'Atualizar permissões e invalidar sessões humanas com controle e registro.', subgroupId: 'seguranca-governanca' },
      { to: '/admin/github-merge', icon: 'mdi-source-merge', title: 'Integração GitHub', tip: 'Executar e acompanhar a integração controlada de alterações empilhadas.', subgroupId: 'operacao' },
      { to: '/admin/teams-recipient-policies', icon: 'mdi-account-group-outline', title: 'Políticas Teams', tip: 'Administrar aprovadores e operadores Teams com verificação de prontidão em simulação e identidades mascaradas.', subgroupId: 'seguranca-governanca' },
      { to: '/orquestrador-ia', icon: 'mdi-sitemap-outline', title: 'Orquestrador IA', tip: 'Classifica demandas por tema e aciona o coordenador de IA correspondente.', subgroupId: 'engenharia-ia' },
    ],
  },
  {
    id: 'arquitetura',
