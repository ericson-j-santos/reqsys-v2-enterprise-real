...
const sections = {
  '/home': {
    ...
    description: 'Ponto de entrada do usuário final com orientação clara, ambiente visível e acesso às áreas principais.',
  },
  '/workspace': {
    title: 'Workspace',
    description: 'Área de trabalho inicial para acompanhar pendências, requisitos e próximas ações operacionais.',
  },
  '/analytics': {
    title: 'Analytics inicial',
    description: 'Visão executiva de indicadores com preparação para drill-down filtrado e rastreável.',
  },
  '/ajuda': {
    title: 'Ajuda e onboarding',
    description: 'Orientação rápida para começar a usar o ReqSys sem depender de documentação externa.',
  },
}
...
const environment = computed(() => {
  ...
  if (['PRD', 'PROD', 'PRODUCTION', 'PRODUCAO'].includes(raw)) {
    return { id: 'PRD', label: 'Produção', color: 'red' }
  }
  if (['HML', 'HOMOLOG', 'HOMOLOGACAO', 'STAGING'].includes(raw)) {
    return { id: 'HML', label: 'Homologação', color: 'amber' }
  }
...
const operationalCards = [
  {
    id: 'requisitos',
    title: 'Requisitos',
    description: 'Consultar e acompanhar o catálogo de requisitos e demandas.',
  ...
  },
  {
    ...
    description: 'Acessar a área de trabalho com filtros preparados para itens pendentes.',
    icon: 'mdi-clipboard-alert-outline',
    status: 'Inicial',
    statusColor: 'amber',
    route: '/workspace?status=pendente',
  },
  {
    id: 'governanca',
    title: 'Governança',
    description: 'Visualizar gates, evidências e trilhas de auditoria em alto nível.',
...
const uiStates = [
  {
    id: 'loading',
    label: 'Carregando',
    message: 'Exibir feedback não bloqueante enquanto dados operacionais são carregados.',
    icon: 'mdi-loading',
    color: 'blue',
  },
  {
    id: 'empty',
    label: 'Sem dados',
    message: 'Explicar o próximo passo quando não houver informações disponíveis.',
  ...
  },
  {
    ...
    message: 'Mostrar mensagem segura e caminho de recuperação sem expor detalhe sensível.',
  ...
  },
  {
    id: 'success',
    label: 'Disponível',
    message: 'Exibir conteúdo e ações primárias quando a área estiver pronta.',
  ...
  },
  {
    ...
    message: 'Orientar login ou permissão necessária sem vazar regra interna.',
...
const nextSteps = [
  {
    ...
    subtitle: 'Entender pendências e itens em andamento.',
    icon: 'mdi-view-dashboard-outline',
  },
  {
    title: 'Consultar requisitos',
    subtitle: 'Acompanhar demanda, status e rastreabilidade.',
    icon: 'mdi-file-search-outline',
  },
  {
    title: 'Ver governança',
    subtitle: 'Conferir gates, evidências e segurança operacional.',
...
.user-final-hero {
  ...
  padding: 24px;
  border-radius: 18px;
  background: linear-gradient(135deg, rgba(0, 83, 160, 0.12), rgba(243, 146, 0, 0.14));
