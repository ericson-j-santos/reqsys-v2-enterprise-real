<template>
  <v-app>
    ...
    <GovBIEmptyStateBridge v-if="$route.path !== '/login'" />
...
import DashboardEmptyStateBridge from './components/DashboardEmptyStateBridge.vue'
import GovBIEmptyStateBridge from './components/GovBIEmptyStateBridge.vue'
