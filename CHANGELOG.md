...
- Runtime Operational Evidence UI em `reports/github-runtime-analytics/runtime-operational-evidence-ui.html` com navegação por nós do grafo JSON, correlações temporais, semáforo report-only e workflow `runtime-operational-evidence-ui.yml`.
