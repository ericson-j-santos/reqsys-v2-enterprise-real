...
- Trilha C padrão ouro na SPA: `SemaforoChip`, `OperationalMetricCard`, `OperationalDrilldownBar`, `IncidentTimelinePanel`, hub `/analytics`, drill-down filtrado em monitoramento/estatísticas, `spa_drilldown` no schema runtime e E2E `trilha-c-operacional.spec.js`.
