...
- Adicionado agregador local `scripts/runtime_health_center.py` para consolidar status operacional por domínio (`ci_cd`, `living_architecture`, `evidence`, `environment`, `governance`, `remediation`).
...
- Documentado o incremento no Runtime Ops Governance P1 e adicionados testes unitários do contrato do relatório.
