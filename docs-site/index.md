...
Caso o ambiente corporativo não permita instalar Python, MkDocs ou dependências externas, utilize o HTML estático versionado localizado em `docs-site/offline/reqsys-docs-v0.1.0.html`.
