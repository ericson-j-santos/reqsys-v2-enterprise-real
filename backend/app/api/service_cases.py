...
from sqlalchemy import DateTime, ForeignKey, Integer, String, UniqueConstraint, func, update
    ...
    *,
    ...
    if replay is not None:
        if (
            ...
            raise ServiceCaseConflictError('event_id já utilizado por outra relação INCIDENT -> PROBLEM')
        return replay, True
