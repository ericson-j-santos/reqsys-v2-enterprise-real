...
const DEFAULT_TARGETS = [
  { name: 'prod-app', environment: 'prod', type: 'app', url: 'https://reqsys-app.fly.dev/', expectedStatus: [200, 301, 302, 401, 403] },
  { name: 'prod-api-health', environment: 'prod', type: 'api', url: 'https://reqsys-api.fly.dev/health', expectedStatus: [200] },
  { name: 'stg-app', environment: 'staging', type: 'app', url: 'https://reqsys-app-stg.fly.dev/', expectedStatus: [200, 301, 302, 401, 403] },
  { name: 'stg-api-health', environment: 'staging', type: 'api', url: 'https://reqsys-api-stg.fly.dev/health', expectedStatus: [200] },
  { name: 'dev-app', environment: 'dev', type: 'app', url: 'https://reqsys-app-dev.fly.dev/', expectedStatus: [200, 301, 302, 401, 403] },
  { name: 'dev-api-health', environment: 'dev', type: 'api', url: 'https://reqsys-api-dev.fly.dev/health', expectedStatus: [200] },
]
