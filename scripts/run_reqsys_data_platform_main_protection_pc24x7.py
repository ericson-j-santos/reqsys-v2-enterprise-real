#!/usr/bin/env python3
"""Protege reqsys-data-platform/main usando autenticação GitHub local do PC24x7."""
...
TARGET_BRANCH = "main"
EXPECTED_TARGET_SHA = "a992d15f6fc4a642ee417ffd93576cccba342c37"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Protege reqsys-data-platform/main via auth local do PC24x7")
