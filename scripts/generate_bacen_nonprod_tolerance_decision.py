...
def build_decision(matrix_path: Path, policy_path: Path, scope: str) -> dict[str, Any]:
    ...
    for control in controls:
        ...
        if status not in VALID_STATUSES:
            ...
            blocking_controls.append(control_id)
        elif scope in allowed_scopes and status in allowed_statuses:
            if status == "partial":
    ...
    review_deadline = generated_at + timedelta(days=review_window_days)
