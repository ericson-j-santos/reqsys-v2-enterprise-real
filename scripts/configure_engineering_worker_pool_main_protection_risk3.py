#!/usr/bin/env python3
"""Instala uma exceção Owner Risk3 temporária para proteger engineering-worker-pool/main."""
...
ACTION_ID = "reqsys.engineering-worker-pool-main-protection.dev"
SCOPE = "repo://ericson-j-santos/engineering-worker-pool/branch/main"
MANAGED_BY = "reqsys-engineering-worker-pool-main-protection-once"
ENABLE_CONFIRM = "ENABLE-ENGINEERING-WORKER-POOL-MAIN-PROTECTION-ONCE"
DISABLE_CONFIRM = "DISABLE-ENGINEERING-WORKER-POOL-MAIN-PROTECTION-ONCE"
EVIDENCE_PATH = "artifacts/engineering-worker-pool-main-protection-pc24x7/evidence.json"
COMMAND = [
    "python",
    "scripts/run_engineering_worker_pool_main_protection_local.py",
    "--output",
    EVIDENCE_PATH,
]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Autoriza uma proteção Risk3 única do engineering-worker-pool/main")
