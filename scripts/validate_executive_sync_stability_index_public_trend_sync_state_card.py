#!/usr/bin/env python3
"""Valida o card do estado sincronizado consolidado no Ops Dashboard."""
...
from scripts.inject_executive_sync_stability_index_public_trend_sync_state_card import CARD_ID, CARD_KEY
...
def validate(html_text: str, runtime_index: dict) -> list[str]:
    ...
    if card.get("eligible_for_human_review") and int(card.get("minimum_stable_sequence", 0) or 0) < 3:
