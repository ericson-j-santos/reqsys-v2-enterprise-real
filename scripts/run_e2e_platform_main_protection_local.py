#!/usr/bin/env python3
"""Protege e2e-platform/main usando apenas a autenticação GitHub local do Noteri."""
...
TARGET_BRANCH = "main"
REQUIRED_CHECK = "contract-self-test"
...
def _write_evidence(path: Path, payload: dict[str, Any]) -> None:
    ...
    fd, temp_name = tempfile.mkstemp(prefix="e2e-platform-protection-", suffix=".json", dir=str(target.parent))
    try:
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Protege e2e-platform/main via auth local do Noteri")
