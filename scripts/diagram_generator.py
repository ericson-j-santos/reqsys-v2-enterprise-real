...
from app.services.diagram_generator import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Gerador Mermaid de arquitetura viva ReqSys")
    parser.add_argument("--path", default="backend/app", help="Diretorio ou arquivo Python para analisar")
    ...
    parser.add_argument("--correlation-id", default="cli-local", help="Identificador de rastreabilidade ADR-003")
    return parser
