#!/usr/bin/env python3
"""Instala uma exceção Owner Risk3 temporária para bootstrap da identidade Teams Bot DEV."""
...
ACTION_ID = "reqsys.teams-bot-dev-identity-bootstrap.dev"
SCOPE = "repo://ericson-j-santos/reqsys-v2-enterprise-real/environment/dev/teams-bot-identity"
MANAGED_BY = "teams-bot-dev-identity-bootstrap-once"
ENABLE_CONFIRM = "ENABLE-TEAMS-BOT-DEV-IDENTITY-BOOTSTRAP-ONCE"
DISABLE_CONFIRM = "DISABLE-TEAMS-BOT-DEV-IDENTITY-BOOTSTRAP-ONCE"
EVIDENCE_PATH = "artifacts/teams-bot-dev-identity-bootstrap/evidence.json"
COMMAND = [
    "python",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Autoriza uma execução Risk3 única do bootstrap Teams Bot DEV")
