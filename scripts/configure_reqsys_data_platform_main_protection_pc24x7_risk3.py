#!/usr/bin/env python3
"""Instala uma autorização Owner Risk3 temporária e exata para proteger reqsys-data-platform/main."""
...
MANAGED_BY = "reqsys-data-platform-main-protection-pc24x7-once"
ENABLE_CONFIRM = "ENABLE-REQSYS-DATA-PLATFORM-MAIN-PROTECTION-PC24X7-ONCE"
DISABLE_CONFIRM = "DISABLE-REQSYS-DATA-PLATFORM-MAIN-PROTECTION-PC24X7-ONCE"
EVIDENCE_PATH = "artifacts/reqsys-data-platform-main-protection-pc24x7/evidence.json"
COMMAND = [
    "python",
    "scripts/run_reqsys_data_platform_main_protection_pc24x7.py",
    "--output",
    EVIDENCE_PATH,
]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Autoriza uma proteção Risk3 única do reqsys-data-platform/main")
