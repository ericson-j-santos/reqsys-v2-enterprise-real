#!/usr/bin/env python3
"""Injeta o estado sincronizado consolidado no Ops Dashboard canônico."""
...
HOOK = "<!-- REQSYS_EXECUTIVE_SYNC_STABILITY_INDEX_PUBLIC_TREND_SYNC_STATE -->"
...
def _render(contract: dict[str, Any]) -> str:
  ...
  <h2>Estado sincronizado consolidado</h2>
  <dl>
