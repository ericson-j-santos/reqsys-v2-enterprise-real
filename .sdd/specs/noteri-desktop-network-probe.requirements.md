...
20. O readback DEVE persistir apenas status HTTP, readiness, quantidade de workers Desktop e booleanos sanitizados `fresh/controller_online/auth_valid/eligible/runner_recovery_capable` mais o perfil; IDs, tokens, corpo bruto, capabilities arbitrárias e segredos são proibidos.
