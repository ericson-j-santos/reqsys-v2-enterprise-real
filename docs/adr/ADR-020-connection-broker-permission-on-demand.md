...
- Pode aumentar complexidade inicial de autenticação.
...
- Arquitetura Viva / Living Architecture.
- Observabilidade com `correlation_id`.
- Gates de produção para autenticação, CORS, JWT, logs e conectores.
