...
MkDocs passa a ser a fonte versionada da documentação viva. O HTML estático em `docs/offline/` atua como fallback corporativo para leitura sem toolchain local.
