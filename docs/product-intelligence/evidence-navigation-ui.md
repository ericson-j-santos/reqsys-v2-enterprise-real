...
Este documento preserva a documentação operacional complementar do PR #225 em branch limpa baseada na `main`, evitando conflito de merge e mantendo o escopo já consolidado na branch principal.
