...
- Branch ativa deste incremento: `agent/reqsys-001-governance-reconciliation-v2`
- Branch base: `main`
...
| `agent/reqsys-001-governance-reconciliation-v1` | `superseded` | a `main` avançou durante a execução | substituída pela branch `v2`, criada diretamente sobre a `main` atual |
