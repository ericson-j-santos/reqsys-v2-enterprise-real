...
- operação offline e determinística;
- sem chamadas externas;
- sem promoção automática;
- sem bloqueio de produção.
...
Todo conteúdo vindo do contrato é escapado antes da renderização HTML. O painel não executa JavaScript e não recebe segredos ou dados pessoais.
