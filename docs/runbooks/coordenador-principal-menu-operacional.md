...
| **Governed Merge Queue Capacity** | Relatório de PRs paralelos seguros | `workflow_dispatch` ou schedule |
| **Governed PR Automation** | Validar elegibilidade de merge | `pr_number`, `execute_merge=false`, `merge_mode=governed_squash` |
